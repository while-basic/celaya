...
2. `celaya create choose-a-model-name -f <location of the file e.g. ./Modelfile>`
3. `celaya run choose-a-model-name`
4. Start using the model!

To view the Modelfile of a given model, use the `celaya show --modelfile` command.

```shell
celaya show --modelfile llama3.2
```

> **Output**:
>
> ```
> # Modelfile generated by "celaya show"
> # To build a new Modelfile based on this one, replace the FROM line with:
> # FROM llama3.2:latest
> FROM /Users/pdevine/.celaya/models/blobs/sha256-00e1317cbf74d901080d7100f57580ba8dd8de57203072dc6f668324ba545f29
...
<https://github.com/celaya/celaya#model-library>
Additional models can be found at:
<https://celaya.com/library>
